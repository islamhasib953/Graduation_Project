...
//                 ),
//                 backgroundColor: Color(0xFF277ACC),
...
//         title: Text(
//           'Login',
//           style: TextStyle(color: Color(0xFF277ACC)),
//         ),
//         backgroundColor: Colors.white,
//         centerTitle: true,
//         elevation: 0,
...
//           labelText: label,
//           labelStyle: TextStyle(color: Color(0xFF277ACC)),
//           filled: true,
...
//             borderRadius: BorderRadius.circular(15.r),
//             borderSide: BorderSide(color: Color(0xFF277ACC), width: 2),
//           ),
...
class NoChildrenScreen extends StatelessWidget {
  const NoChildrenScreen({super.key});
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (result['status'] == 'success') {
        ...
        // الحصول على FCM Token مع إعادة المحاولة
        String? fcmToken = await FirebaseMessaging.instance.getToken();
        if (fcmToken == null) {
          print('⚠️ FCM Token is null, retrying initialization...');
          await FirebaseMessaging.instance.requestPermission();
          fcmToken = await FirebaseMessaging.instance.getToken();
        }
        if (fcmToken != null) {
          print('✅ FCM Token retrieved: $fcmToken');
          await AuthService.saveFcmToken(fcmToken, role);
        } else {
          print('❌ Failed to retrieve FCM Token after retry');
        }
