...
const registerUser = asyncWrapper(async (req, res, next) => {
    const { firstName, lastName, gender, phone, address, email, password, role } = req.body;
...
const updateUser = asyncWrapper(async (req, res, next) => {
    const { userId } = req.params;
    const { firstName, lastName, gender, phone, address, password, avatar } = req.body;
...
const deleteUser = asyncWrapper(async (req, res, next) => {
    ...
    res.json({ status: httpStatusText.SUCCESS, message: "User deleted successfully" });
});
